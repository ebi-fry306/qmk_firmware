...
[_RAISE] = LAYOUT( \
  ...
  KC_F1,  KC_F2,    KC_F3,   KC_F4,   KC_F5,   KC_F6,                       KC_PLUS, KC_MINS, KC_UP,   KC_LBRC, KC_RBRC, XXXXXXX, \
  KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,   _______, _______,  KC_EQL , KC_LEFT, KC_DOWN, KC_RGHT, XXXXXXX, KC_BSLS, \
                             _______, _______, _______,  _______, _______,  _______, KC_DEL, _______ \
),
/* ADJUST
 * ,-----------------------------------------.                    ,-----------------------------------------.
